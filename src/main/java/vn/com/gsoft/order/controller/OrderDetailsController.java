...
public class OrderDetailsController {
    ...
    public ResponseEntity<BaseResponse> colection(@RequestBody OrderDetailsReq objReq) throws Exception {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> colectionList(@RequestBody OrderDetailsReq objReq) throws Exception {
    ...
    public ResponseEntity<BaseResponse> insert(@Valid @RequestBody OrderDetailsReq objReq) throws Exception {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public ResponseEntity<BaseResponse> update(@Valid @RequestBody OrderDetailsReq objReq) throws Exception {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> delete(@Valid @RequestBody OrderDetailsReq idSearchReq) throws Exception {
